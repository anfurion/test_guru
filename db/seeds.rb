...
meat = Test.create(title: 'meat', level: 7, category: cooking)
...
fish = Test.create(title: 'Fish', level: 7, category: cooking)
...
drive_a_bike = Test.create(title: 'drive_a_bike', level: 8, category: drive)
...
drive_a_car = Test.create(title: 'Drive_a_car', level: 9, category: drive)
...
rpg = Test.create(title: 'RPG', level: 7, category: game)
...
poker = Test.create(title: 'Poker', level: 8, category: game)
